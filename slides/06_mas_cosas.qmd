...
Entonces, ¿cómo lo hacemos? os lo cuento en [este post](/blog/20_referencias-bibliograficas.html){target="_blank"}
...
- Ya vimos [aquí](/blog/71_tablas-con-R.html){target="_blank"} que se podían hacer tablas muy chulas con R, pero muchas veces hay que **presentar los resultados** de contrastes o de la **estimación de modelos estadísticos**.
...
- En el curso se habla de las extensiones. En las slides nº5, concretamente [aquí](https://perezp44.github.io/intro.to.quarto/slides/05_primer_web.html?q=extens#/extensiones) y en [este post](/blog/23_extensiones.html#listado-de-extensiones){target="_blank"} y en [este otro](/blog/70_botoncitos-web.html){target="_blank"}
...
- Lo haríamos con [este post](/blog/74_trucos-css.html){target="_blank"} del blog
