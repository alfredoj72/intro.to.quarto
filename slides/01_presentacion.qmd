...
|                         | Slides con Quarto :exclamation:\       | (con slides 04)\   |
+-------------------------+----------------------------------------+--------------------+
| 28 de junio (miércoles) | Mi primer web/blog\                    | (con slides 05)\   |
+-------------------------+----------------------------------------+--------------------+
| 3 de julio (lunes)      | Más cosas con Quarto :exclamation:\    | (con slides 06)\   |
+-------------------------+----------------------------------------+--------------------+
...
-   No soy bloguero pero he impartido el **taller** [Mi primer blog con Quarto](https://perezp44.github.io/taller.primer.blog/){target="blank"} en las XII Jornadas de usuarios de R. Algunos de mis blogs:
