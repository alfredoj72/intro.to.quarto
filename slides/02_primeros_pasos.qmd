...
::: {.column width="59%"}
![[Some good practices for research with R](https://www.good-practices.etiennebacher.com/#/title-slide)](imagenes/ss_02_img_02H.png){fig-align="left" width="65%"}
:::
:::
...
- Elementos interactivos. Por ejemplo [aquí](https://perezp44.github.io/intro.to.quarto/blog/27_observable.html)
