...
[Aquí](https://github.com/quarto-dev/quarto-cli/discussions/3953) una discisón sobre una "Linked figure with linked caption in quarto".

[ggview](https://twitter.com/iaroslav_domin/status/1596663360740794368) un paquete de R para ver que tamaño de gráfico necesitats, sin salir de Rstudio!!. [Aquí](https://github.com/idmn/ggview) el repo.
