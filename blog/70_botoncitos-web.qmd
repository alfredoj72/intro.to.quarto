...
``` html
<button type="button" class="btn btn-primary">
<img src="recursos/ababol.jpg" alt="buttonpng" border="0" />
</button>
```

<button type="button" class="btn btn-primary">

<img src="imagenes/ababol.jpg" alt="buttonpng" border="0"/>
...
-   No, como véis, no me ha salido!!!! 😥 Pero ya no pruebo más 😞🤕
